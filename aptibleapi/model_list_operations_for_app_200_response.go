...
// checks if the ListOperationsForApp200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForApp200Response{}

// ListOperationsForApp200Response struct for ListOperationsForApp200Response
type ListOperationsForApp200Response struct {
	Embedded ListOperationsForApp200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForApp200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForApp200Response ListOperationsForApp200Response
...
func NewListOperationsForApp200Response(embedded ListOperationsForApp200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForApp200ResponseLinks) *ListOperationsForApp200Response {
	this := ListOperationsForApp200Response{}
...
func (o *ListOperationsForApp200Response) GetEmbedded() ListOperationsForApp200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForApp200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForApp200Response) GetLinks() ListOperationsForApp200ResponseLinks {
	if o == nil {
		var ret ListOperationsForApp200ResponseLinks
		return ret
	}
...
func (o ListOperationsForApp200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForApp200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForApp200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForApp200Response := _ListOperationsForApp200Response{}

	err = json.Unmarshal(data, &varListOperationsForApp200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForApp200Response(varListOperationsForApp200Response)
...
type NullableListOperationsForApp200Response struct {
	value *ListOperationsForApp200Response
	isSet bool
}

func (v NullableListOperationsForApp200Response) Get() *ListOperationsForApp200Response {
	return v.value
}

func (v *NullableListOperationsForApp200Response) Set(val *ListOperationsForApp200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForApp200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForApp200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForApp200Response(val *ListOperationsForApp200Response) *NullableListOperationsForApp200Response {
	return &NullableListOperationsForApp200Response{value: val, isSet: true}
}

func (v NullableListOperationsForApp200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForApp200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
