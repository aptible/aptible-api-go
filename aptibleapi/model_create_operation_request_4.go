...
// checks if the CreateOperationRequest4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest4{}

// CreateOperationRequest4 struct for CreateOperationRequest4
type CreateOperationRequest4 struct {
...
type _CreateOperationRequest4 CreateOperationRequest4
...
func (o CreateOperationRequest4) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest4) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest4) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest4 := _CreateOperationRequest4{}

	err = json.Unmarshal(data, &varCreateOperationRequest4)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest4(varCreateOperationRequest4)
...
type NullableCreateOperationRequest4 struct {
	value *CreateOperationRequest4
	isSet bool
}

func (v NullableCreateOperationRequest4) Get() *CreateOperationRequest4 {
	return v.value
}

func (v *NullableCreateOperationRequest4) Set(val *CreateOperationRequest4) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest4) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest4(val *CreateOperationRequest4) *NullableCreateOperationRequest4 {
	return &NullableCreateOperationRequest4{value: val, isSet: true}
}

func (v NullableCreateOperationRequest4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest4) UnmarshalJSON(src []byte) error {
	v.isSet = true
