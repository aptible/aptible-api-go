...
func (r ApiGetBackupRequest) NoEmbed(noEmbed bool) ApiGetBackupRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiGetBackupRequest) Prefer(prefer string) ApiGetBackupRequest {
	r.prefer = &prefer
	return r
}
...
Returns the details of a specific backup by ID.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListBackupsRequest) NoEmbed(noEmbed bool) ApiListBackupsRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListBackupsRequest) Prefer(prefer string) ApiListBackupsRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of all backups.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListBackupsForAccountRequest) NoEmbed(noEmbed bool) ApiListBackupsForAccountRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListBackupsForAccountRequest) Prefer(prefer string) ApiListBackupsForAccountRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of backups for the specified account.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListBackupsForDatabaseRequest) NoEmbed(noEmbed bool) ApiListBackupsForDatabaseRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListBackupsForDatabaseRequest) Prefer(prefer string) ApiListBackupsForDatabaseRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of backups for the specified database.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListCopiesForBackupRequest) NoEmbed(noEmbed bool) ApiListCopiesForBackupRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListCopiesForBackupRequest) Prefer(prefer string) ApiListCopiesForBackupRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of copies for the specified backup.
