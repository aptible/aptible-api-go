...
type LogDrain struct {
	...
	DrainUsername NullableString `json:"drain_username,omitempty"`
	DrainPassword NullableString `json:"drain_password,omitempty"`
	...
	LoggingToken NullableString `json:"logging_token,omitempty"`
...
// GetDrainUsername returns the DrainUsername field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LogDrain) GetDrainUsername() string {
	if o == nil || IsNil(o.DrainUsername.Get()) {
		var ret string
		return ret
	}
...
func (o *LogDrain) HasDrainUsername() bool {
	if o != nil && o.DrainUsername.IsSet() {
		return true
	}
...
// SetDrainUsername gets a reference to the given NullableString and assigns it to the DrainUsername field.
...
func (o *LogDrain) SetDrainUsernameNil() {
	o.DrainUsername.Set(nil)
}
...
func (o *LogDrain) UnsetDrainUsername() {
	o.DrainUsername.Unset()
}

// GetDrainPassword returns the DrainPassword field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LogDrain) GetDrainPassword() string {
	if o == nil || IsNil(o.DrainPassword.Get()) {
		var ret string
		return ret
	}
...
func (o *LogDrain) HasDrainPassword() bool {
	if o != nil && o.DrainPassword.IsSet() {
		return true
	}
...
// SetDrainPassword gets a reference to the given NullableString and assigns it to the DrainPassword field.
...
func (o *LogDrain) SetDrainPasswordNil() {
	o.DrainPassword.Set(nil)
}
...
// GetLoggingToken returns the LoggingToken field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LogDrain) GetLoggingToken() string {
	if o == nil || IsNil(o.LoggingToken.Get()) {
		var ret string
		return ret
	}
...
// SetLoggingToken gets a reference to the given NullableString and assigns it to the LoggingToken field.
...
func (o *LogDrain) SetLoggingTokenNil() {
	o.LoggingToken.Set(nil)
}
...
func (o LogDrain) ToMap() (map[string]interface{}, error) {
	...
	if o.DrainUsername.IsSet() {
		toSerialize["drain_username"] = o.DrainUsername.Get()
	}
	if o.DrainPassword.IsSet() {
