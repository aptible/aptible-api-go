...
// checks if the ListOperationsForVhost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForVhost200Response{}

// ListOperationsForVhost200Response struct for ListOperationsForVhost200Response
type ListOperationsForVhost200Response struct {
	Embedded ListOperationsForVhost200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForVhost200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForVhost200Response ListOperationsForVhost200Response
...
func NewListOperationsForVhost200Response(embedded ListOperationsForVhost200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForVhost200ResponseLinks) *ListOperationsForVhost200Response {
	this := ListOperationsForVhost200Response{}
...
func (o *ListOperationsForVhost200Response) GetEmbedded() ListOperationsForVhost200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForVhost200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForVhost200Response) GetLinks() ListOperationsForVhost200ResponseLinks {
	if o == nil {
		var ret ListOperationsForVhost200ResponseLinks
		return ret
	}
...
func (o ListOperationsForVhost200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForVhost200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForVhost200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForVhost200Response := _ListOperationsForVhost200Response{}

	err = json.Unmarshal(data, &varListOperationsForVhost200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForVhost200Response(varListOperationsForVhost200Response)
...
type NullableListOperationsForVhost200Response struct {
	value *ListOperationsForVhost200Response
	isSet bool
}

func (v NullableListOperationsForVhost200Response) Get() *ListOperationsForVhost200Response {
	return v.value
}

func (v *NullableListOperationsForVhost200Response) Set(val *ListOperationsForVhost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForVhost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForVhost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForVhost200Response(val *ListOperationsForVhost200Response) *NullableListOperationsForVhost200Response {
	return &NullableListOperationsForVhost200Response{value: val, isSet: true}
}

func (v NullableListOperationsForVhost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForVhost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
