...
func (r ApiGetRootRequest) NoEmbed(noEmbed bool) ApiGetRootRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiGetRootRequest) Prefer(prefer string) ApiGetRootRequest {
	r.prefer = &prefer
	return r
}
...
Returns the root resource with links to top-level collections.
...
func (a *RootAPIService) GetRootExecute(r ApiGetRootRequest) (*GetRoot200Response, *http.Response, error) {
	var (
