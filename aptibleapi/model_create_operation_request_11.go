...
// checks if the CreateOperationRequest11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest11{}

// CreateOperationRequest11 struct for CreateOperationRequest11
type CreateOperationRequest11 struct {
...
type _CreateOperationRequest11 CreateOperationRequest11
...
func (o CreateOperationRequest11) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest11) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest11) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest11 := _CreateOperationRequest11{}

	err = json.Unmarshal(data, &varCreateOperationRequest11)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest11(varCreateOperationRequest11)
...
type NullableCreateOperationRequest11 struct {
	value *CreateOperationRequest11
	isSet bool
}

func (v NullableCreateOperationRequest11) Get() *CreateOperationRequest11 {
	return v.value
}

func (v *NullableCreateOperationRequest11) Set(val *CreateOperationRequest11) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest11) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest11) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest11(val *CreateOperationRequest11) *NullableCreateOperationRequest11 {
	return &NullableCreateOperationRequest11{value: val, isSet: true}
}

func (v NullableCreateOperationRequest11) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest11) UnmarshalJSON(src []byte) error {
	v.isSet = true
