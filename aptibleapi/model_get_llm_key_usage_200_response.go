...
// checks if the GetLlmKeyUsage200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLlmKeyUsage200Response{}

// GetLlmKeyUsage200Response struct for GetLlmKeyUsage200Response
type GetLlmKeyUsage200Response struct {
	// Total spend in USD
...
type _GetLlmKeyUsage200Response GetLlmKeyUsage200Response
...
func NewGetLlmKeyUsage200Response() *GetLlmKeyUsage200Response {
	this := GetLlmKeyUsage200Response{}
	return &this
}
...
func (o GetLlmKeyUsage200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLlmKeyUsage200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetLlmKeyUsage200Response) UnmarshalJSON(data []byte) (err error) {
	varGetLlmKeyUsage200Response := _GetLlmKeyUsage200Response{}

	err = json.Unmarshal(data, &varGetLlmKeyUsage200Response)

	if err != nil {
		return err
	}

	*o = GetLlmKeyUsage200Response(varGetLlmKeyUsage200Response)
...
type NullableGetLlmKeyUsage200Response struct {
	value *GetLlmKeyUsage200Response
	isSet bool
}

func (v NullableGetLlmKeyUsage200Response) Get() *GetLlmKeyUsage200Response {
	return v.value
}

func (v *NullableGetLlmKeyUsage200Response) Set(val *GetLlmKeyUsage200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLlmKeyUsage200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLlmKeyUsage200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLlmKeyUsage200Response(val *GetLlmKeyUsage200Response) *NullableGetLlmKeyUsage200Response {
	return &NullableGetLlmKeyUsage200Response{value: val, isSet: true}
}

func (v NullableGetLlmKeyUsage200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLlmKeyUsage200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
