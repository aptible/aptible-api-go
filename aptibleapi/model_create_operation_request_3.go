...
// checks if the CreateOperationRequest3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest3{}

// CreateOperationRequest3 struct for CreateOperationRequest3
type CreateOperationRequest3 struct {
...
type _CreateOperationRequest3 CreateOperationRequest3
...
func (o CreateOperationRequest3) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest3) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest3) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest3 := _CreateOperationRequest3{}

	err = json.Unmarshal(data, &varCreateOperationRequest3)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest3(varCreateOperationRequest3)
...
type NullableCreateOperationRequest3 struct {
	value *CreateOperationRequest3
	isSet bool
}

func (v NullableCreateOperationRequest3) Get() *CreateOperationRequest3 {
	return v.value
}

func (v *NullableCreateOperationRequest3) Set(val *CreateOperationRequest3) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest3) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest3(val *CreateOperationRequest3) *NullableCreateOperationRequest3 {
	return &NullableCreateOperationRequest3{value: val, isSet: true}
}

func (v NullableCreateOperationRequest3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest3) UnmarshalJSON(src []byte) error {
	v.isSet = true
