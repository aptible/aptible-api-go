...
// checks if the ListServicesForApp200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListServicesForApp200Response{}

// ListServicesForApp200Response struct for ListServicesForApp200Response
type ListServicesForApp200Response struct {
	Embedded ListServicesForApp200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListServicesForApp200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListServicesForApp200Response ListServicesForApp200Response
...
func NewListServicesForApp200Response(embedded ListServicesForApp200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListServicesForApp200ResponseLinks) *ListServicesForApp200Response {
	this := ListServicesForApp200Response{}
...
func (o *ListServicesForApp200Response) GetEmbedded() ListServicesForApp200ResponseEmbedded {
	if o == nil {
		var ret ListServicesForApp200ResponseEmbedded
		return ret
	}
...
func (o *ListServicesForApp200Response) GetLinks() ListServicesForApp200ResponseLinks {
	if o == nil {
		var ret ListServicesForApp200ResponseLinks
		return ret
	}
...
func (o ListServicesForApp200Response) MarshalJSON() ([]byte, error) {
...
func (o ListServicesForApp200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListServicesForApp200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListServicesForApp200Response := _ListServicesForApp200Response{}

	err = json.Unmarshal(data, &varListServicesForApp200Response)

	if err != nil {
		return err
	}

	*o = ListServicesForApp200Response(varListServicesForApp200Response)
...
type NullableListServicesForApp200Response struct {
	value *ListServicesForApp200Response
	isSet bool
}

func (v NullableListServicesForApp200Response) Get() *ListServicesForApp200Response {
	return v.value
}

func (v *NullableListServicesForApp200Response) Set(val *ListServicesForApp200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListServicesForApp200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListServicesForApp200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListServicesForApp200Response(val *ListServicesForApp200Response) *NullableListServicesForApp200Response {
	return &NullableListServicesForApp200Response{value: val, isSet: true}
}

func (v NullableListServicesForApp200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListServicesForApp200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
