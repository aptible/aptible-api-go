...
// checks if the ListOperationsForDatabaseCredential200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForDatabaseCredential200Response{}

// ListOperationsForDatabaseCredential200Response struct for ListOperationsForDatabaseCredential200Response
type ListOperationsForDatabaseCredential200Response struct {
	Embedded ListOperationsForDatabaseCredential200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForDatabaseCredential200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForDatabaseCredential200Response ListOperationsForDatabaseCredential200Response
...
func NewListOperationsForDatabaseCredential200Response(embedded ListOperationsForDatabaseCredential200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForDatabaseCredential200ResponseLinks) *ListOperationsForDatabaseCredential200Response {
	this := ListOperationsForDatabaseCredential200Response{}
...
func (o *ListOperationsForDatabaseCredential200Response) GetEmbedded() ListOperationsForDatabaseCredential200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForDatabaseCredential200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForDatabaseCredential200Response) GetLinks() ListOperationsForDatabaseCredential200ResponseLinks {
	if o == nil {
		var ret ListOperationsForDatabaseCredential200ResponseLinks
		return ret
	}
...
func (o ListOperationsForDatabaseCredential200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForDatabaseCredential200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForDatabaseCredential200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForDatabaseCredential200Response := _ListOperationsForDatabaseCredential200Response{}

	err = json.Unmarshal(data, &varListOperationsForDatabaseCredential200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForDatabaseCredential200Response(varListOperationsForDatabaseCredential200Response)
...
type NullableListOperationsForDatabaseCredential200Response struct {
	value *ListOperationsForDatabaseCredential200Response
	isSet bool
}

func (v NullableListOperationsForDatabaseCredential200Response) Get() *ListOperationsForDatabaseCredential200Response {
	return v.value
}

func (v *NullableListOperationsForDatabaseCredential200Response) Set(val *ListOperationsForDatabaseCredential200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForDatabaseCredential200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForDatabaseCredential200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForDatabaseCredential200Response(val *ListOperationsForDatabaseCredential200Response) *NullableListOperationsForDatabaseCredential200Response {
	return &NullableListOperationsForDatabaseCredential200Response{value: val, isSet: true}
}

func (v NullableListOperationsForDatabaseCredential200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForDatabaseCredential200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
