...
// checks if the CreateOperationRequest6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest6{}

// CreateOperationRequest6 struct for CreateOperationRequest6
type CreateOperationRequest6 struct {
...
type _CreateOperationRequest6 CreateOperationRequest6
...
func (o CreateOperationRequest6) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest6) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest6) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest6 := _CreateOperationRequest6{}

	err = json.Unmarshal(data, &varCreateOperationRequest6)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest6(varCreateOperationRequest6)
...
type NullableCreateOperationRequest6 struct {
	value *CreateOperationRequest6
	isSet bool
}

func (v NullableCreateOperationRequest6) Get() *CreateOperationRequest6 {
	return v.value
}

func (v *NullableCreateOperationRequest6) Set(val *CreateOperationRequest6) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest6) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest6(val *CreateOperationRequest6) *NullableCreateOperationRequest6 {
	return &NullableCreateOperationRequest6{value: val, isSet: true}
}

func (v NullableCreateOperationRequest6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest6) UnmarshalJSON(src []byte) error {
	v.isSet = true
