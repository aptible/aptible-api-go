...
type ListBackupsForAccount200ResponseLinks struct {
	Account *ListBackupsForAccount200ResponseLinksAccount `json:"account,omitempty"`
	Database *ListBackupsForAccount200ResponseLinksDatabase `json:"database,omitempty"`
	Next *ListBackupsForAccount200ResponseLinksNext `json:"next,omitempty"`
	Prev *ListBackupsForAccount200ResponseLinksPrev `json:"prev,omitempty"`
	Self *ListBackupsForAccount200ResponseLinksSelf `json:"self,omitempty"`
...
func (o *ListBackupsForAccount200ResponseLinks) GetAccount() ListBackupsForAccount200ResponseLinksAccount {
	if o == nil || IsNil(o.Account) {
		var ret ListBackupsForAccount200ResponseLinksAccount
		return ret
	}
	return *o.Account
}
...
// SetAccount gets a reference to the given ListBackupsForAccount200ResponseLinksAccount and assigns it to the Account field.
...
func (o *ListBackupsForAccount200ResponseLinks) GetDatabase() ListBackupsForAccount200ResponseLinksDatabase {
	if o == nil || IsNil(o.Database) {
		var ret ListBackupsForAccount200ResponseLinksDatabase
		return ret
	}
	return *o.Database
}
...
// SetDatabase gets a reference to the given ListBackupsForAccount200ResponseLinksDatabase and assigns it to the Database field.
...
func (o *ListBackupsForAccount200ResponseLinks) GetNext() ListBackupsForAccount200ResponseLinksNext {
	if o == nil || IsNil(o.Next) {
		var ret ListBackupsForAccount200ResponseLinksNext
		return ret
	}
	return *o.Next
}
...
// SetNext gets a reference to the given ListBackupsForAccount200ResponseLinksNext and assigns it to the Next field.
...
func (o *ListBackupsForAccount200ResponseLinks) GetPrev() ListBackupsForAccount200ResponseLinksPrev {
	if o == nil || IsNil(o.Prev) {
		var ret ListBackupsForAccount200ResponseLinksPrev
		return ret
	}
	return *o.Prev
}
...
// SetPrev gets a reference to the given ListBackupsForAccount200ResponseLinksPrev and assigns it to the Prev field.
...
func (o *ListBackupsForAccount200ResponseLinks) GetSelf() ListBackupsForAccount200ResponseLinksSelf {
	if o == nil || IsNil(o.Self) {
		var ret ListBackupsForAccount200ResponseLinksSelf
		return ret
	}
	return *o.Self
}
...
// SetSelf gets a reference to the given ListBackupsForAccount200ResponseLinksSelf and assigns it to the Self field.
