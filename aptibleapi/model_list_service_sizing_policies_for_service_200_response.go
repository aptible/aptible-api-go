...
// checks if the ListServiceSizingPoliciesForService200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListServiceSizingPoliciesForService200Response{}

// ListServiceSizingPoliciesForService200Response struct for ListServiceSizingPoliciesForService200Response
type ListServiceSizingPoliciesForService200Response struct {
	Embedded ListServiceSizingPoliciesForService200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListServiceSizingPoliciesForService200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListServiceSizingPoliciesForService200Response ListServiceSizingPoliciesForService200Response
...
func NewListServiceSizingPoliciesForService200Response(embedded ListServiceSizingPoliciesForService200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListServiceSizingPoliciesForService200ResponseLinks) *ListServiceSizingPoliciesForService200Response {
	this := ListServiceSizingPoliciesForService200Response{}
...
func (o *ListServiceSizingPoliciesForService200Response) GetEmbedded() ListServiceSizingPoliciesForService200ResponseEmbedded {
	if o == nil {
		var ret ListServiceSizingPoliciesForService200ResponseEmbedded
		return ret
	}
...
func (o *ListServiceSizingPoliciesForService200Response) GetLinks() ListServiceSizingPoliciesForService200ResponseLinks {
	if o == nil {
		var ret ListServiceSizingPoliciesForService200ResponseLinks
		return ret
	}
...
func (o ListServiceSizingPoliciesForService200Response) MarshalJSON() ([]byte, error) {
...
func (o ListServiceSizingPoliciesForService200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListServiceSizingPoliciesForService200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListServiceSizingPoliciesForService200Response := _ListServiceSizingPoliciesForService200Response{}

	err = json.Unmarshal(data, &varListServiceSizingPoliciesForService200Response)

	if err != nil {
		return err
	}

	*o = ListServiceSizingPoliciesForService200Response(varListServiceSizingPoliciesForService200Response)
...
type NullableListServiceSizingPoliciesForService200Response struct {
	value *ListServiceSizingPoliciesForService200Response
	isSet bool
}

func (v NullableListServiceSizingPoliciesForService200Response) Get() *ListServiceSizingPoliciesForService200Response {
	return v.value
}

func (v *NullableListServiceSizingPoliciesForService200Response) Set(val *ListServiceSizingPoliciesForService200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListServiceSizingPoliciesForService200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListServiceSizingPoliciesForService200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListServiceSizingPoliciesForService200Response(val *ListServiceSizingPoliciesForService200Response) *NullableListServiceSizingPoliciesForService200Response {
	return &NullableListServiceSizingPoliciesForService200Response{value: val, isSet: true}
}

func (v NullableListServiceSizingPoliciesForService200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListServiceSizingPoliciesForService200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
