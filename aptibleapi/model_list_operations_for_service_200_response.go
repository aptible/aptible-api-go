...
// checks if the ListOperationsForService200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForService200Response{}

// ListOperationsForService200Response struct for ListOperationsForService200Response
type ListOperationsForService200Response struct {
	Embedded ListOperationsForService200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForService200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForService200Response ListOperationsForService200Response
...
func NewListOperationsForService200Response(embedded ListOperationsForService200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForService200ResponseLinks) *ListOperationsForService200Response {
	this := ListOperationsForService200Response{}
...
func (o *ListOperationsForService200Response) GetEmbedded() ListOperationsForService200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForService200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForService200Response) GetLinks() ListOperationsForService200ResponseLinks {
	if o == nil {
		var ret ListOperationsForService200ResponseLinks
		return ret
	}
...
func (o ListOperationsForService200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForService200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForService200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForService200Response := _ListOperationsForService200Response{}

	err = json.Unmarshal(data, &varListOperationsForService200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForService200Response(varListOperationsForService200Response)
...
type NullableListOperationsForService200Response struct {
	value *ListOperationsForService200Response
	isSet bool
}

func (v NullableListOperationsForService200Response) Get() *ListOperationsForService200Response {
	return v.value
}

func (v *NullableListOperationsForService200Response) Set(val *ListOperationsForService200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForService200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForService200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForService200Response(val *ListOperationsForService200Response) *NullableListOperationsForService200Response {
	return &NullableListOperationsForService200Response{value: val, isSet: true}
}

func (v NullableListOperationsForService200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForService200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
