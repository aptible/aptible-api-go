...
// checks if the CreateOperationRequest9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest9{}

// CreateOperationRequest9 struct for CreateOperationRequest9
type CreateOperationRequest9 struct {
...
type _CreateOperationRequest9 CreateOperationRequest9
...
func (o CreateOperationRequest9) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest9) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest9) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest9 := _CreateOperationRequest9{}

	err = json.Unmarshal(data, &varCreateOperationRequest9)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest9(varCreateOperationRequest9)
...
type NullableCreateOperationRequest9 struct {
	value *CreateOperationRequest9
	isSet bool
}

func (v NullableCreateOperationRequest9) Get() *CreateOperationRequest9 {
	return v.value
}

func (v *NullableCreateOperationRequest9) Set(val *CreateOperationRequest9) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest9) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest9(val *CreateOperationRequest9) *NullableCreateOperationRequest9 {
	return &NullableCreateOperationRequest9{value: val, isSet: true}
}

func (v NullableCreateOperationRequest9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest9) UnmarshalJSON(src []byte) error {
	v.isSet = true
