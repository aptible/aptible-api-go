...
func (r ApiGetLlmKeyRequest) NoEmbed(noEmbed bool) ApiGetLlmKeyRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiGetLlmKeyRequest) Prefer(prefer string) ApiGetLlmKeyRequest {
	r.prefer = &prefer
	return r
}
...
Returns the details of a specific LLM key by ID.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiGetLlmKeyRequestsRequest) NoEmbed(noEmbed bool) ApiGetLlmKeyRequestsRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiGetLlmKeyRequestsRequest) Prefer(prefer string) ApiGetLlmKeyRequestsRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of API requests made with the specified LLM key.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiGetLlmKeyUsageRequest) NoEmbed(noEmbed bool) ApiGetLlmKeyUsageRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiGetLlmKeyUsageRequest) Prefer(prefer string) ApiGetLlmKeyUsageRequest {
	r.prefer = &prefer
	return r
}
...
Returns aggregated usage statistics for the specified LLM key over a date range.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListLlmKeysRequest) NoEmbed(noEmbed bool) ApiListLlmKeysRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListLlmKeysRequest) Prefer(prefer string) ApiListLlmKeysRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of all LLM keys.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListLlmKeysForAccountRequest) NoEmbed(noEmbed bool) ApiListLlmKeysForAccountRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListLlmKeysForAccountRequest) Prefer(prefer string) ApiListLlmKeysForAccountRequest {
	r.prefer = &prefer
	return r
}
...
Returns a list of LLM keys for the specified account.
...
Revokes and deletes the specified LLM key.
