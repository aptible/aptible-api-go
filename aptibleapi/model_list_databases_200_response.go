...
type ListDatabases200Response struct {
	Embedded ListDatabases200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListDatabases200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListDatabases200Response ListDatabases200Response
...
func (o *ListDatabases200Response) GetEmbedded() ListDatabases200ResponseEmbedded {
	if o == nil {
		var ret ListDatabases200ResponseEmbedded
		return ret
	}
...
func (o *ListDatabases200Response) GetLinks() ListDatabases200ResponseLinks {
	if o == nil {
		var ret ListDatabases200ResponseLinks
		return ret
	}
...
func (o *ListDatabases200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDatabases200Response := _ListDatabases200Response{}

	err = json.Unmarshal(data, &varListDatabases200Response)

	if err != nil {
		return err
	}

	*o = ListDatabases200Response(varListDatabases200Response)
