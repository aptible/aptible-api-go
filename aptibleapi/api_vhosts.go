...
func (r ApiCreateVhostRequest) NoEmbed(noEmbed bool) ApiCreateVhostRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiCreateVhostRequest) Prefer(prefer string) ApiCreateVhostRequest {
	r.prefer = &prefer
	return r
}
...
Creates a new vhost for the specified service.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiGetVhostRequest) NoEmbed(noEmbed bool) ApiGetVhostRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiGetVhostRequest) Prefer(prefer string) ApiGetVhostRequest {
	r.prefer = &prefer
	return r
}
...
Returns the details of a specific vhost by ID.
...
func (r ApiListVhostsForAccountRequest) PerPage(perPage int32) ApiListVhostsForAccountRequest {
	r.perPage = &perPage
	return r
}

// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListVhostsForAccountRequest) NoEmbed(noEmbed bool) ApiListVhostsForAccountRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListVhostsForAccountRequest) Prefer(prefer string) ApiListVhostsForAccountRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of vhosts belonging to the specified account.
...
// Number of results to return per page
func (r ApiListVhostsForAppRequest) PerPage(perPage int32) ApiListVhostsForAppRequest {
	r.perPage = &perPage
	return r
}

// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListVhostsForAppRequest) NoEmbed(noEmbed bool) ApiListVhostsForAppRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListVhostsForAppRequest) Prefer(prefer string) ApiListVhostsForAppRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of vhosts belonging to the specified app.
...
// Number of results to return per page
func (r ApiListVhostsForCertificateRequest) PerPage(perPage int32) ApiListVhostsForCertificateRequest {
	r.perPage = &perPage
	return r
}

// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListVhostsForCertificateRequest) NoEmbed(noEmbed bool) ApiListVhostsForCertificateRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListVhostsForCertificateRequest) Prefer(prefer string) ApiListVhostsForCertificateRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of vhosts associated with the specified certificate.
...
// Number of results to return per page
func (r ApiListVhostsForServiceRequest) PerPage(perPage int32) ApiListVhostsForServiceRequest {
	r.perPage = &perPage
	return r
}

// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiListVhostsForServiceRequest) NoEmbed(noEmbed bool) ApiListVhostsForServiceRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiListVhostsForServiceRequest) Prefer(prefer string) ApiListVhostsForServiceRequest {
	r.prefer = &prefer
	return r
}
...
Returns a paginated list of vhosts belonging to the specified service.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiPatchVhostRequest) NoEmbed(noEmbed bool) ApiPatchVhostRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiPatchVhostRequest) Prefer(prefer string) ApiPatchVhostRequest {
	r.prefer = &prefer
	return r
}
...
Partially updates a vhost's attributes.
...
// When true, omits embedded resources from the response. Also triggered when the Prefer: no_sensitive_extras&#x3D;true header is present.
func (r ApiUpdateVhostRequest) NoEmbed(noEmbed bool) ApiUpdateVhostRequest {
	r.noEmbed = &noEmbed
	return r
}

// When set to no_sensitive_extras&#x3D;true, omits sensitive fields and embedded resources from the response.
func (r ApiUpdateVhostRequest) Prefer(prefer string) ApiUpdateVhostRequest {
	r.prefer = &prefer
	return r
}
