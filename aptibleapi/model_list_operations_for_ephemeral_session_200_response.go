...
// checks if the ListOperationsForEphemeralSession200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForEphemeralSession200Response{}

// ListOperationsForEphemeralSession200Response struct for ListOperationsForEphemeralSession200Response
type ListOperationsForEphemeralSession200Response struct {
	Embedded ListOperationsForEphemeralSession200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForEphemeralSession200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForEphemeralSession200Response ListOperationsForEphemeralSession200Response
...
func NewListOperationsForEphemeralSession200Response(embedded ListOperationsForEphemeralSession200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForEphemeralSession200ResponseLinks) *ListOperationsForEphemeralSession200Response {
	this := ListOperationsForEphemeralSession200Response{}
...
func (o *ListOperationsForEphemeralSession200Response) GetEmbedded() ListOperationsForEphemeralSession200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForEphemeralSession200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForEphemeralSession200Response) GetLinks() ListOperationsForEphemeralSession200ResponseLinks {
	if o == nil {
		var ret ListOperationsForEphemeralSession200ResponseLinks
		return ret
	}
...
func (o ListOperationsForEphemeralSession200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForEphemeralSession200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForEphemeralSession200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForEphemeralSession200Response := _ListOperationsForEphemeralSession200Response{}

	err = json.Unmarshal(data, &varListOperationsForEphemeralSession200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForEphemeralSession200Response(varListOperationsForEphemeralSession200Response)
...
type NullableListOperationsForEphemeralSession200Response struct {
	value *ListOperationsForEphemeralSession200Response
	isSet bool
}

func (v NullableListOperationsForEphemeralSession200Response) Get() *ListOperationsForEphemeralSession200Response {
	return v.value
}

func (v *NullableListOperationsForEphemeralSession200Response) Set(val *ListOperationsForEphemeralSession200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForEphemeralSession200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForEphemeralSession200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForEphemeralSession200Response(val *ListOperationsForEphemeralSession200Response) *NullableListOperationsForEphemeralSession200Response {
	return &NullableListOperationsForEphemeralSession200Response{value: val, isSet: true}
}

func (v NullableListOperationsForEphemeralSession200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForEphemeralSession200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
