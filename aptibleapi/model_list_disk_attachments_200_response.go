...
// checks if the ListDiskAttachments200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDiskAttachments200Response{}

// ListDiskAttachments200Response struct for ListDiskAttachments200Response
type ListDiskAttachments200Response struct {
...
type _ListDiskAttachments200Response ListDiskAttachments200Response
...
func NewListDiskAttachments200Response(embedded ListDiskAttachmentsForAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListDatabaseImages200ResponseLinks) *ListDiskAttachments200Response {
	this := ListDiskAttachments200Response{}
...
func (o ListDiskAttachments200Response) MarshalJSON() ([]byte, error) {
...
func (o ListDiskAttachments200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListDiskAttachments200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDiskAttachments200Response := _ListDiskAttachments200Response{}

	err = json.Unmarshal(data, &varListDiskAttachments200Response)

	if err != nil {
		return err
	}

	*o = ListDiskAttachments200Response(varListDiskAttachments200Response)
...
type NullableListDiskAttachments200Response struct {
	value *ListDiskAttachments200Response
	isSet bool
}

func (v NullableListDiskAttachments200Response) Get() *ListDiskAttachments200Response {
	return v.value
}

func (v *NullableListDiskAttachments200Response) Set(val *ListDiskAttachments200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDiskAttachments200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDiskAttachments200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDiskAttachments200Response(val *ListDiskAttachments200Response) *NullableListDiskAttachments200Response {
	return &NullableListDiskAttachments200Response{value: val, isSet: true}
}

func (v NullableListDiskAttachments200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDiskAttachments200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
