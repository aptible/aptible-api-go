...
// checks if the ListVhostsForApp200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVhostsForApp200Response{}

// ListVhostsForApp200Response struct for ListVhostsForApp200Response
type ListVhostsForApp200Response struct {
	Embedded ListVhostsForApp200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListVhostsForApp200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListVhostsForApp200Response ListVhostsForApp200Response
...
func NewListVhostsForApp200Response(embedded ListVhostsForApp200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListVhostsForApp200ResponseLinks) *ListVhostsForApp200Response {
	this := ListVhostsForApp200Response{}
...
func (o *ListVhostsForApp200Response) GetEmbedded() ListVhostsForApp200ResponseEmbedded {
	if o == nil {
		var ret ListVhostsForApp200ResponseEmbedded
		return ret
	}
...
func (o *ListVhostsForApp200Response) GetLinks() ListVhostsForApp200ResponseLinks {
	if o == nil {
		var ret ListVhostsForApp200ResponseLinks
		return ret
	}
...
func (o ListVhostsForApp200Response) MarshalJSON() ([]byte, error) {
...
func (o ListVhostsForApp200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListVhostsForApp200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListVhostsForApp200Response := _ListVhostsForApp200Response{}

	err = json.Unmarshal(data, &varListVhostsForApp200Response)

	if err != nil {
		return err
	}

	*o = ListVhostsForApp200Response(varListVhostsForApp200Response)
...
type NullableListVhostsForApp200Response struct {
	value *ListVhostsForApp200Response
	isSet bool
}

func (v NullableListVhostsForApp200Response) Get() *ListVhostsForApp200Response {
	return v.value
}

func (v *NullableListVhostsForApp200Response) Set(val *ListVhostsForApp200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListVhostsForApp200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListVhostsForApp200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVhostsForApp200Response(val *ListVhostsForApp200Response) *NullableListVhostsForApp200Response {
	return &NullableListVhostsForApp200Response{value: val, isSet: true}
}

func (v NullableListVhostsForApp200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVhostsForApp200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
