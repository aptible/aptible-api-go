...
type Database struct {
	...
	ConnectionUrl NullableString `json:"connection_url,omitempty"`
...
func (o *Database) SetPassphraseNil() {
...
// GetConnectionUrl returns the ConnectionUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Database) GetConnectionUrl() string {
	if o == nil || IsNil(o.ConnectionUrl.Get()) {
		var ret string
		return ret
	}
...
func (o *Database) HasConnectionUrl() bool {
	if o != nil && o.ConnectionUrl.IsSet() {
		return true
	}
...
// SetConnectionUrl gets a reference to the given NullableString and assigns it to the ConnectionUrl field.
...
func (o *Database) SetConnectionUrlNil() {
	o.ConnectionUrl.Set(nil)
}
