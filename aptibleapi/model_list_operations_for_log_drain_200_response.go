...
// checks if the ListOperationsForLogDrain200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForLogDrain200Response{}

// ListOperationsForLogDrain200Response struct for ListOperationsForLogDrain200Response
type ListOperationsForLogDrain200Response struct {
	Embedded ListOperationsForLogDrain200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForLogDrain200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForLogDrain200Response ListOperationsForLogDrain200Response
...
func NewListOperationsForLogDrain200Response(embedded ListOperationsForLogDrain200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForLogDrain200ResponseLinks) *ListOperationsForLogDrain200Response {
	this := ListOperationsForLogDrain200Response{}
...
func (o *ListOperationsForLogDrain200Response) GetEmbedded() ListOperationsForLogDrain200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForLogDrain200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForLogDrain200Response) GetLinks() ListOperationsForLogDrain200ResponseLinks {
	if o == nil {
		var ret ListOperationsForLogDrain200ResponseLinks
		return ret
	}
...
func (o ListOperationsForLogDrain200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForLogDrain200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForLogDrain200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForLogDrain200Response := _ListOperationsForLogDrain200Response{}

	err = json.Unmarshal(data, &varListOperationsForLogDrain200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForLogDrain200Response(varListOperationsForLogDrain200Response)
...
type NullableListOperationsForLogDrain200Response struct {
	value *ListOperationsForLogDrain200Response
	isSet bool
}

func (v NullableListOperationsForLogDrain200Response) Get() *ListOperationsForLogDrain200Response {
	return v.value
}

func (v *NullableListOperationsForLogDrain200Response) Set(val *ListOperationsForLogDrain200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForLogDrain200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForLogDrain200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForLogDrain200Response(val *ListOperationsForLogDrain200Response) *NullableListOperationsForLogDrain200Response {
	return &NullableListOperationsForLogDrain200Response{value: val, isSet: true}
}

func (v NullableListOperationsForLogDrain200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForLogDrain200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
