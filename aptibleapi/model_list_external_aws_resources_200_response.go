...
// checks if the ListExternalAwsResources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListExternalAwsResources200Response{}

// ListExternalAwsResources200Response struct for ListExternalAwsResources200Response
type ListExternalAwsResources200Response struct {
...
type _ListExternalAwsResources200Response ListExternalAwsResources200Response
...
func NewListExternalAwsResources200Response(embedded ListExternalAwsResourcesForExternalAwsAccount200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListDatabaseImages200ResponseLinks) *ListExternalAwsResources200Response {
	this := ListExternalAwsResources200Response{}
...
func (o ListExternalAwsResources200Response) MarshalJSON() ([]byte, error) {
...
func (o ListExternalAwsResources200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListExternalAwsResources200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListExternalAwsResources200Response := _ListExternalAwsResources200Response{}

	err = json.Unmarshal(data, &varListExternalAwsResources200Response)

	if err != nil {
		return err
	}

	*o = ListExternalAwsResources200Response(varListExternalAwsResources200Response)
...
type NullableListExternalAwsResources200Response struct {
	value *ListExternalAwsResources200Response
	isSet bool
}

func (v NullableListExternalAwsResources200Response) Get() *ListExternalAwsResources200Response {
	return v.value
}

func (v *NullableListExternalAwsResources200Response) Set(val *ListExternalAwsResources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListExternalAwsResources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListExternalAwsResources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListExternalAwsResources200Response(val *ListExternalAwsResources200Response) *NullableListExternalAwsResources200Response {
	return &NullableListExternalAwsResources200Response{value: val, isSet: true}
}

func (v NullableListExternalAwsResources200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListExternalAwsResources200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
