...
// checks if the MetricDrainsMetricDrainIdContainersGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricDrainsMetricDrainIdContainersGet200Response{}

// MetricDrainsMetricDrainIdContainersGet200Response struct for MetricDrainsMetricDrainIdContainersGet200Response
type MetricDrainsMetricDrainIdContainersGet200Response struct {
	Embedded MetricDrainsMetricDrainIdContainersGet200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links MetricDrainsMetricDrainIdContainersGet200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _MetricDrainsMetricDrainIdContainersGet200Response MetricDrainsMetricDrainIdContainersGet200Response
...
func NewMetricDrainsMetricDrainIdContainersGet200Response(embedded MetricDrainsMetricDrainIdContainersGet200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links MetricDrainsMetricDrainIdContainersGet200ResponseLinks) *MetricDrainsMetricDrainIdContainersGet200Response {
	this := MetricDrainsMetricDrainIdContainersGet200Response{}
...
func (o *MetricDrainsMetricDrainIdContainersGet200Response) GetEmbedded() MetricDrainsMetricDrainIdContainersGet200ResponseEmbedded {
	if o == nil {
		var ret MetricDrainsMetricDrainIdContainersGet200ResponseEmbedded
		return ret
	}
...
func (o *MetricDrainsMetricDrainIdContainersGet200Response) GetLinks() MetricDrainsMetricDrainIdContainersGet200ResponseLinks {
	if o == nil {
		var ret MetricDrainsMetricDrainIdContainersGet200ResponseLinks
		return ret
	}
...
func (o MetricDrainsMetricDrainIdContainersGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MetricDrainsMetricDrainIdContainersGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *MetricDrainsMetricDrainIdContainersGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricDrainsMetricDrainIdContainersGet200Response := _MetricDrainsMetricDrainIdContainersGet200Response{}

	err = json.Unmarshal(data, &varMetricDrainsMetricDrainIdContainersGet200Response)

	if err != nil {
		return err
	}

	*o = MetricDrainsMetricDrainIdContainersGet200Response(varMetricDrainsMetricDrainIdContainersGet200Response)
...
type NullableMetricDrainsMetricDrainIdContainersGet200Response struct {
	value *MetricDrainsMetricDrainIdContainersGet200Response
	isSet bool
}

func (v NullableMetricDrainsMetricDrainIdContainersGet200Response) Get() *MetricDrainsMetricDrainIdContainersGet200Response {
	return v.value
}

func (v *NullableMetricDrainsMetricDrainIdContainersGet200Response) Set(val *MetricDrainsMetricDrainIdContainersGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricDrainsMetricDrainIdContainersGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricDrainsMetricDrainIdContainersGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricDrainsMetricDrainIdContainersGet200Response(val *MetricDrainsMetricDrainIdContainersGet200Response) *NullableMetricDrainsMetricDrainIdContainersGet200Response {
	return &NullableMetricDrainsMetricDrainIdContainersGet200Response{value: val, isSet: true}
}

func (v NullableMetricDrainsMetricDrainIdContainersGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricDrainsMetricDrainIdContainersGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
