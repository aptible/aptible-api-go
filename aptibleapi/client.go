...
// APIClient manages communication with the Aptible API v1 API vv1
...
type APIClient struct {
	...
	MaintenancesAPI *MaintenancesAPIService
...
func NewAPIClient(cfg *APIConfiguration) *APIClient {
	...
	c.MaintenancesAPI = (*MaintenancesAPIService)(&c.common)
