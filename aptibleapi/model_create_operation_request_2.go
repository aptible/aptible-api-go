...
// checks if the CreateOperationRequest2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest2{}

// CreateOperationRequest2 struct for CreateOperationRequest2
type CreateOperationRequest2 struct {
...
type _CreateOperationRequest2 CreateOperationRequest2
...
func (o CreateOperationRequest2) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest2) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest2) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest2 := _CreateOperationRequest2{}

	err = json.Unmarshal(data, &varCreateOperationRequest2)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest2(varCreateOperationRequest2)
...
type NullableCreateOperationRequest2 struct {
	value *CreateOperationRequest2
	isSet bool
}

func (v NullableCreateOperationRequest2) Get() *CreateOperationRequest2 {
	return v.value
}

func (v *NullableCreateOperationRequest2) Set(val *CreateOperationRequest2) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest2) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest2(val *CreateOperationRequest2) *NullableCreateOperationRequest2 {
	return &NullableCreateOperationRequest2{value: val, isSet: true}
}

func (v NullableCreateOperationRequest2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest2) UnmarshalJSON(src []byte) error {
	v.isSet = true
