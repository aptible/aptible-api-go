...
> ActivityReport GetActivityReport(ctx, id).NoEmbed(noEmbed).Prefer(prefer).Execute()
...
func main() {
	...
	resp, r, err := apiClient.ActivityReportsAPI.GetActivityReport(context.Background(), id).NoEmbed(noEmbed).Prefer(prefer).Execute()
	if err != nil {
...
> GetActivityReportDownload(ctx, activityReportId).NoEmbed(noEmbed).Prefer(prefer).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ActivityReportsAPI.GetActivityReportDownload(context.Background(), activityReportId).NoEmbed(noEmbed).Prefer(prefer).Execute()
	if err != nil {
...
> ListActivityReportsForAccount200Response ListActivityReportsForAccount(ctx, accountId).Page(page).PerPage(perPage).NoEmbed(noEmbed).Prefer(prefer).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ActivityReportsAPI.ListActivityReportsForAccount(context.Background(), accountId).Page(page).PerPage(perPage).NoEmbed(noEmbed).Prefer(prefer).Execute()
	if err != nil {
