...
// checks if the ListOperationsForImage200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOperationsForImage200Response{}

// ListOperationsForImage200Response struct for ListOperationsForImage200Response
type ListOperationsForImage200Response struct {
	Embedded ListOperationsForImage200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListOperationsForImage200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListOperationsForImage200Response ListOperationsForImage200Response
...
func NewListOperationsForImage200Response(embedded ListOperationsForImage200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListOperationsForImage200ResponseLinks) *ListOperationsForImage200Response {
	this := ListOperationsForImage200Response{}
...
func (o *ListOperationsForImage200Response) GetEmbedded() ListOperationsForImage200ResponseEmbedded {
	if o == nil {
		var ret ListOperationsForImage200ResponseEmbedded
		return ret
	}
...
func (o *ListOperationsForImage200Response) GetLinks() ListOperationsForImage200ResponseLinks {
	if o == nil {
		var ret ListOperationsForImage200ResponseLinks
		return ret
	}
...
func (o ListOperationsForImage200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOperationsForImage200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOperationsForImage200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOperationsForImage200Response := _ListOperationsForImage200Response{}

	err = json.Unmarshal(data, &varListOperationsForImage200Response)

	if err != nil {
		return err
	}

	*o = ListOperationsForImage200Response(varListOperationsForImage200Response)
...
type NullableListOperationsForImage200Response struct {
	value *ListOperationsForImage200Response
	isSet bool
}

func (v NullableListOperationsForImage200Response) Get() *ListOperationsForImage200Response {
	return v.value
}

func (v *NullableListOperationsForImage200Response) Set(val *ListOperationsForImage200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOperationsForImage200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOperationsForImage200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOperationsForImage200Response(val *ListOperationsForImage200Response) *NullableListOperationsForImage200Response {
	return &NullableListOperationsForImage200Response{value: val, isSet: true}
}

func (v NullableListOperationsForImage200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOperationsForImage200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
