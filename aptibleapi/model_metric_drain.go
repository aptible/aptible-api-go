...
type MetricDrain struct {
	...
	DrainConfiguration *MetricDrainDrainConfiguration `json:"drain_configuration,omitempty"`
...
// SetDrainConfiguration gets a reference to the given MetricDrainDrainConfiguration and assigns it to the DrainConfiguration field.
