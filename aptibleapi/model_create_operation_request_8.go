...
// checks if the CreateOperationRequest8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest8{}

// CreateOperationRequest8 struct for CreateOperationRequest8
type CreateOperationRequest8 struct {
...
type _CreateOperationRequest8 CreateOperationRequest8
...
func (o CreateOperationRequest8) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest8) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest8) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest8 := _CreateOperationRequest8{}

	err = json.Unmarshal(data, &varCreateOperationRequest8)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest8(varCreateOperationRequest8)
...
type NullableCreateOperationRequest8 struct {
	value *CreateOperationRequest8
	isSet bool
}

func (v NullableCreateOperationRequest8) Get() *CreateOperationRequest8 {
	return v.value
}

func (v *NullableCreateOperationRequest8) Set(val *CreateOperationRequest8) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest8) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest8(val *CreateOperationRequest8) *NullableCreateOperationRequest8 {
	return &NullableCreateOperationRequest8{value: val, isSet: true}
}

func (v NullableCreateOperationRequest8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest8) UnmarshalJSON(src []byte) error {
	v.isSet = true
