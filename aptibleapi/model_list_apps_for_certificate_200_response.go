...
// checks if the ListAppsForCertificate200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAppsForCertificate200Response{}

// ListAppsForCertificate200Response struct for ListAppsForCertificate200Response
type ListAppsForCertificate200Response struct {
	Embedded ListAppsForCertificate200ResponseEmbedded `json:"_embedded"`
	TotalCount int32 `json:"total_count"`
	PerPage int32 `json:"per_page"`
	CurrentPage int32 `json:"current_page"`
	Links ListAppsForCertificate200ResponseLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ListAppsForCertificate200Response ListAppsForCertificate200Response
...
func NewListAppsForCertificate200Response(embedded ListAppsForCertificate200ResponseEmbedded, totalCount int32, perPage int32, currentPage int32, links ListAppsForCertificate200ResponseLinks) *ListAppsForCertificate200Response {
	this := ListAppsForCertificate200Response{}
...
func (o *ListAppsForCertificate200Response) GetEmbedded() ListAppsForCertificate200ResponseEmbedded {
	if o == nil {
		var ret ListAppsForCertificate200ResponseEmbedded
		return ret
	}
...
func (o *ListAppsForCertificate200Response) GetLinks() ListAppsForCertificate200ResponseLinks {
	if o == nil {
		var ret ListAppsForCertificate200ResponseLinks
		return ret
	}
...
func (o ListAppsForCertificate200Response) MarshalJSON() ([]byte, error) {
...
func (o ListAppsForCertificate200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListAppsForCertificate200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListAppsForCertificate200Response := _ListAppsForCertificate200Response{}

	err = json.Unmarshal(data, &varListAppsForCertificate200Response)

	if err != nil {
		return err
	}

	*o = ListAppsForCertificate200Response(varListAppsForCertificate200Response)
...
type NullableListAppsForCertificate200Response struct {
	value *ListAppsForCertificate200Response
	isSet bool
}

func (v NullableListAppsForCertificate200Response) Get() *ListAppsForCertificate200Response {
	return v.value
}

func (v *NullableListAppsForCertificate200Response) Set(val *ListAppsForCertificate200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListAppsForCertificate200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListAppsForCertificate200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAppsForCertificate200Response(val *ListAppsForCertificate200Response) *NullableListAppsForCertificate200Response {
	return &NullableListAppsForCertificate200Response{value: val, isSet: true}
}

func (v NullableListAppsForCertificate200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAppsForCertificate200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
