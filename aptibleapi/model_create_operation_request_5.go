...
// checks if the CreateOperationRequest5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOperationRequest5{}

// CreateOperationRequest5 struct for CreateOperationRequest5
type CreateOperationRequest5 struct {
...
type _CreateOperationRequest5 CreateOperationRequest5
...
func (o CreateOperationRequest5) MarshalJSON() ([]byte, error) {
...
func (o CreateOperationRequest5) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOperationRequest5) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOperationRequest5 := _CreateOperationRequest5{}

	err = json.Unmarshal(data, &varCreateOperationRequest5)

	if err != nil {
		return err
	}

	*o = CreateOperationRequest5(varCreateOperationRequest5)
...
type NullableCreateOperationRequest5 struct {
	value *CreateOperationRequest5
	isSet bool
}

func (v NullableCreateOperationRequest5) Get() *CreateOperationRequest5 {
	return v.value
}

func (v *NullableCreateOperationRequest5) Set(val *CreateOperationRequest5) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOperationRequest5) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOperationRequest5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOperationRequest5(val *CreateOperationRequest5) *NullableCreateOperationRequest5 {
	return &NullableCreateOperationRequest5{value: val, isSet: true}
}

func (v NullableCreateOperationRequest5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOperationRequest5) UnmarshalJSON(src []byte) error {
	v.isSet = true
